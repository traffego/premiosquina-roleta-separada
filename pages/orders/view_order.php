                        ...
                        <div class=" card mb-2 card-girar<?= $i ?>">
                            <div class="card-body">
                                <div class="roleta-premiada--giros">
                                    <p class="opacity-50 font-xs mb-1">Você tem (<?= $row_status['roleta'] ?>) giro(s) disponíveis:</p>
                ...
                <div id="card-caixa" class="card card-caixa-abrir<?= $i ?> mb-2">
                    ...
                    <div class="card-body">
                        <div class="caixa-premiada--giros">
                            <p class="opacity-50 font-xs mb-1">Você tem (<?= $row_status['roleta'] ?>) caixa(s) disponíveis:</p>
                            <div class="lista font-xs">
                                <div>
