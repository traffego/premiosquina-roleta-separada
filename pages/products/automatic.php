                        ...
                        <div class="card <?= $bgTheme ?>">
                            <div class="card-body pb-1">
                                <div class="">
                                    <?php
                                    $count = 0;
                                    // Calcular giros por pacote de desconto
                                    $cpg = isset($roleta_cotas_por_giro) ? (int)$roleta_cotas_por_giro : 0;

                                    foreach ($discounts as $discount) {
                                        $giros_deste_pacote = ($cpg > 0) ? (int)floor($discount['qty'] / $cpg) : 1;
                                        if (!$roleta && !$box) { ?>
                                                ...
                                                if ($user_id) { ?>
                                                    ...
                                                    <?php } else { ?>
                                                        ...
                                                        <span class="font-weight-500">
                                                            ...
                                                            <small>COTAS POR </small> <span class="font-weight-600 fs-6"><span id="discount_amount_<?= $count ?>" style="display:none">
                                                                    <?= $discount['amount'] ?>
                                                                </span>
                                                                <?php
                                                ...
                                                <?php if ($user_id) { ?>
                                                    ...
                                                    <?php } else { ?>
                                                        ...
                                                        <div class="row mb-1 font-xs">
                                                            ...
                                                            <div class="col-auto">
                                                                <div>Recebe <?= $giros_deste_pacote ?></div>
